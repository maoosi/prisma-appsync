...
await $`concurrently --kill-others --names "SRC,INTEGRATION" -c "bgBlue.black,bgYellow.black" "nodemon --watch 'src/**/*' -e ts --exec 'pnpm build && cd tests/integration && npx prisma generate'" "nodemon tests/integration/server.ts"`
