...
export class AppSyncCdkStack extends cdk.Stack {
    constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
        ...
        const lambdaFunction = new NodejsFunction(this, `${process.env.SERVICES_PREFIX}_Function`, {
            ...
            handler: 'main',
            entry: path.join(__dirname, String(process.env.ROOT_DIR_PATH), String(process.env.HANDLER_FUNCTION_PATH)),
            memorySize: 1536,
            ...
            bundling: {
                ...
                commandHooks: {
                    beforeBundling(inputDir: string, outputDir: string): string[] {
                        const prismaSchema = path.join(inputDir, String(process.env.PRISMA_SCHEMA_PATH))

                        return [`cp ${prismaSchema} ${outputDir}`]
                    },
                    beforeInstall() {
                        return []
                    },
